...
?>
	...
	<div class="row">
		<div id="epi" class="span9 topfat">
		<div class="row">
			<div class="span4">
			<h3 class="tit3">Organizadores:</h3>	
			<ul class="inline">
				<li><a href="http://www.arteceha.com/CEHA/ceha.html" title="Comité Español de Historia del Arte"><img src="<?php echo $genvars['blogtheme']; ?>/images/organiza.ceha.png" alt="Comité Español de Historia del Arte" /></a></li>
				<li><a href="http://uclm.es" title="Universidad de Castilla- La Mancha"><img src="<?php echo $genvars['blogtheme']; ?>/images/organiza.uclm.png" alt="Universidad de Castilla- La Mancha" /></a></li>
			</ul>
			</div>
			<div class="span5">
		...
		<div class="row">
			...
			<ul class="inline">
				...
				<li>Desarrollo web: <a href="http://montera34.com">montera34</a></small></li>
			</ul>
			</div>
		</div>
		</div><!-- #epi -->
